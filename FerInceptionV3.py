...
class FerInceptionV3(CNNetwork):
    ...
    def build(self, num_emotions):
        ...
        INPUT:
        - num_emotions: The amount of the emotion classes: 0=Angry/Disgust, 1=Fear, 2=Happy, 3=Sad, 4=Surprise, 5=Neutral
        """
        ...
        predictions = Dense(units=num_emotions, activation='softmax', name='predictions')(dense_01)
    ...
    # TODO: Implementation of the testing process for the Inception-v3 network
